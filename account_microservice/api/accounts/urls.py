...
urlpatterns = [
    ...
    path('', AdminAccountsViewSet.as_view({'get': 'accounts', 'post': 'create'}), name="sign_out"),# /api/Accounts/
    path('/<int:id>', AdminAccountsViewSet.as_view({'put': 'update', 'delete': 'destroy'}),
